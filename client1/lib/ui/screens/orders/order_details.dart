...
class OrderDetalis extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    ...
    return BlocProvider.value(
      value: OrdersCubit()..getOrderDetails(order_id: orderId),
      child: BlocConsumer<OrdersCubit, OrdersState>(
        listener: (context, state) {
          ...
          if (state is UpdateStatusSuccessState) {
            cubit.getOrders(limit: limit, page: cubit.currentIndex, sort: 'newest', status: cubit.status);
          }
                      ...
                      Row(
                        ...
                        children: [
                                  ...
                                  children: [
                                    Row(
                                      children: [
                                        ...
                                        cubit.orderDetailsModel!.status == 'approved'
                                            ? Text(
                                                'Approved',
                                                style: TextStyle(
                                                    color: Colors.green,
                                            ...
                                            : cubit.orderDetailsModel!.status ==
                                                    'pending'
                                                ? Text(
                                                    'Pending',
                                                    style: TextStyle(
                                    ...
                                    Row(
                                      children: [
                                        ...
                                        SizedBox(
                                          width: width * 0.145,
                                          child: Text(
                                            '${NumberFormat('#,###').format(cubit.orderDetailsModel!.totalPrice)}\€',
                                            style: TextStyle(
                                                color: basicColor,
                                                fontSize: 24.sp,
                                                fontWeight: FontWeight.w600),
                                    ...
                                    Text(
                                      '${DateFormat("yyyy/MM/dd : HH:m:s").format(DateTime.parse(cubit.orderDetailsModel!.createdAt!))}',
                                      style: TextStyle(
                                          color: Colors.grey,
                                          fontSize: 23.sp,
                          ...
                          Container(
                            ...
                            padding: EdgeInsets.symmetric(
                                horizontal: width * 0.02, vertical: height * 0.01),
                            child: cubit.orderDetailsModel!.status == 'pending' ? Column(
                              mainAxisAlignment: MainAxisAlignment.spaceEvenly,
                              children: [
                                Text(
                                  'Update Order Status: ',
                            ...
                            ) : cubit.orderDetailsModel!.status == 'approved' ? Icon(Icons.check,color: Colors.green,size: 60.sp,) : Icon(Icons.close,color: Colors.red,size: 60.sp,),
                          ),
                        ],
                      ),
                      SizedBox(
                      ...
                      SizedBox(
                        ...
                        child: ListView.separated(
                          ...
                          itemBuilder: (context, mainIndex) {
                            var path =
                                '${url}${cubit.orderDetailsModel!.productsOrderDetailsList![mainIndex].image}';
                            return Container(
                              decoration: BoxDecoration(
                                color: Colors.white,
                                borderRadius: BorderRadius.circular(15),
                                    ...
                                    children: [
                                      ...
                                      SizedBox(
                                        ...
                                        child: Column(
                                          ...
                                          children: [
                                            Text(
                                              '${cubit.orderDetailsModel!.productsOrderDetailsList![mainIndex].productName}',
                                              style: TextStyle(
                                                  fontWeight: FontWeight.bold,
                                                  fontSize: 24.sp,
                                                  color: primaryColor),
                                            ...
                                            Text(
                                              '#${cubit.orderDetailsModel!.productsOrderDetailsList![mainIndex].barCode}',
                                              style: TextStyle(
                                                  fontWeight: FontWeight.bold,
                                                  fontSize: 18.sp,
                                                  color: Colors.yellow),
                                    ...
                                    child: ListView.separated(
                                      ...
                                      itemBuilder: (context, index) => Container(
                                        ...
                                        child: Column(
                                          ...
                                          children: [
                                            Text(
                                              '${cubit.orderDetailsModel!.productsOrderDetailsList![mainIndex].productUnitsOrderDetailsList![index].unitOrderModel!.unitName}',
                                              style: TextStyle(
                                                  color: primaryColor,
                                                  fontSize: 22.sp,
                                                  fontWeight: FontWeight.w600),
                                            ...
                                            Text(
                                              '${cubit.orderDetailsModel!.productsOrderDetailsList![mainIndex].productUnitsOrderDetailsList![index].desc}',
                                              style: TextStyle(
                                                  color: Colors.grey,
                                                  fontSize: 18.sp,
                                                  fontWeight: FontWeight.w600),
                                            ...
                                            Text(
                                              'Amount: ${cubit.orderDetailsModel!.productsOrderDetailsList![mainIndex].productUnitsOrderDetailsList![index].unitDetailsOrderModel!.amount}',
                                              style: TextStyle(
                                                  color: Colors.black,
                                                  fontSize: 16.sp,
                                                  fontWeight: FontWeight.w600),
                                            ...
                                            Text(
                                              '${cubit.orderDetailsModel!.productsOrderDetailsList![mainIndex].productUnitsOrderDetailsList![index].unitDetailsOrderModel!.totalPrice}€',
                                              style: TextStyle(
                                                  color: basicColor,
                                                  fontSize: 20.sp,
                                                  fontWeight: FontWeight.bold),
                          ...
                          itemCount: cubit
                              .orderDetailsModel!.productsOrderDetailsList!.length,
                        ),
                      ),
                    ],
                  ),
